    ...
    try {
        ...
        */
        ...
        if (comment.upvotes.includes(userId)) {
            ...
            return res.status(200).json({ message: "Voto removido com sucesso", comment });
        } else {
            ...
            if (false /*comment.author?._id.toString() !== user?._id.toString()*/) {
            ...
            return res.status(200).json({ message: "Voto positivo adicionado com sucesso", comment });
        }
    } catch (err) {
