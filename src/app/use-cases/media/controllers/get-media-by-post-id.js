      ...
      const media = await Media.find({ post: post?._id })
        ...
        .populate({
          ...
          populate: {
            path: "author",
            select:
              "username name is_verified activity_status blocked_users gender posts_count subscribers following followers bio email website cover_photo profile_image",
          },
        })
